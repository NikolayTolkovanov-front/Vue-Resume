		...
		<div class="w-full md:w-1/3 text-left">
			...
			<div class="flex justify-center sm:block">
				...
				>
					...
					></i> -->
					<font-awesome-icon icon="fa-solid fa-circle-down" class="ml-0 sm:ml-1 mr-2 sm:mr-1 w-5 sm:w-6 duration-100" />
					<span
